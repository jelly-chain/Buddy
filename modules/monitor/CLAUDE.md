...
## Purpose
Implements the **monitor** capability in Buddy.

## Runtime
- Entry point: `modules/monitor/run.mjs`
- Tools: `modules/monitor/tools/index.mjs`
- Dispatcher usage: `node modules/monitor/run.mjs &lt;tool&gt; [--arg value]`
