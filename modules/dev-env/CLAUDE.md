...
## Purpose
Implements the **dev-env** capability in Buddy.

## Runtime
- Entry point: `modules/dev-env/run.mjs`
- Tools: `modules/dev-env/tools/index.mjs`
- Dispatcher usage: `node modules/dev-env/run.mjs &lt;tool&gt; [--arg value]`
