...
## Purpose
Implements the **localization** capability in Buddy.

## Runtime
- Entry point: `modules/localization/run.mjs`
- Tools: `modules/localization/tools/index.mjs`
- Dispatcher usage: `node modules/localization/run.mjs &lt;tool&gt; [--arg value]`
