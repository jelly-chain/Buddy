...
## Purpose
Implements the **repl** capability in Buddy.

## Runtime
- Entry point: `modules/repl/run.mjs`
- Tools: `modules/repl/tools/index.mjs`
- Dispatcher usage: `node modules/repl/run.mjs &lt;tool&gt; [--arg value]`
