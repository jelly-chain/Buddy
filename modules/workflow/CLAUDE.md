...
## Purpose
Implements the **workflow** capability in Buddy.

## Runtime
- Entry point: `modules/workflow/run.mjs`
- Tools: `modules/workflow/tools/index.mjs`
- Dispatcher usage: `node modules/workflow/run.mjs &lt;tool&gt; [--arg value]`
