...
## Purpose
Implements the **macos** capability in Buddy.

## Runtime
- Entry point: `modules/macos/run.mjs`
- Tools: `modules/macos/tools/index.mjs`
- Dispatcher usage: `node modules/macos/run.mjs &lt;tool&gt; [--arg value]`
