...
## Purpose
Implements the **timelock** capability in Buddy.

## Runtime
- Entry point: `modules/timelock/run.mjs`
- Tools: `modules/timelock/tools/index.mjs`
- Dispatcher usage: `node modules/timelock/run.mjs &lt;tool&gt; [--arg value]`
