...
## Purpose
Implements the **calendar-sync** capability in Buddy.

## Runtime
- Entry point: `modules/calendar-sync/run.mjs`
- Tools: `modules/calendar-sync/tools/index.mjs`
- Dispatcher usage: `node modules/calendar-sync/run.mjs &lt;tool&gt; [--arg value]`
