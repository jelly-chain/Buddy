...
## Purpose
Implements the **security** capability in Buddy.

## Runtime
- Entry point: `modules/security/run.mjs`
- Tools: `modules/security/tools/index.mjs`
- Dispatcher usage: `node modules/security/run.mjs &lt;tool&gt; [--arg value]`
