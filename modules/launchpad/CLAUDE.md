...
## Purpose
Implements the **launchpad** capability in Buddy.

## Runtime
- Entry point: `modules/launchpad/run.mjs`
- Tools: `modules/launchpad/tools/index.mjs`
- Dispatcher usage: `node modules/launchpad/run.mjs &lt;tool&gt; [--arg value]`
