...
## Purpose
Implements the **dashboard** capability in Buddy.

## Runtime
- Entry point: `modules/dashboard/run.mjs`
- Tools: `modules/dashboard/tools/index.mjs`
- Dispatcher usage: `node modules/dashboard/run.mjs &lt;tool&gt; [--arg value]`
