...
## Purpose
Implements the **files** capability in Buddy.

## Runtime
- Entry point: `modules/files/run.mjs`
- Tools: `modules/files/tools/index.mjs`
- Dispatcher usage: `node modules/files/run.mjs &lt;tool&gt; [--arg value]`
