...
## Purpose
Implements the **evm** capability in Buddy.

## Runtime
- Entry point: `modules/evm/run.mjs`
- Tools: `modules/evm/tools/index.mjs`
- Dispatcher usage: `node modules/evm/run.mjs &lt;tool&gt; [--arg value]`
