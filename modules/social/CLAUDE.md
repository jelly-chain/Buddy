...
## Purpose
Implements the **social** capability in Buddy.

## Runtime
- Entry point: `modules/social/run.mjs`
- Tools: `modules/social/tools/index.mjs`
- Dispatcher usage: `node modules/social/run.mjs &lt;tool&gt; [--arg value]`
