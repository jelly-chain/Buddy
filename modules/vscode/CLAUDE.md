...
## Purpose
Implements the **vscode** capability in Buddy.

## Runtime
- Entry point: `modules/vscode/run.mjs`
- Tools: `modules/vscode/tools/index.mjs`
- Dispatcher usage: `node modules/vscode/run.mjs &lt;tool&gt; [--arg value]`
