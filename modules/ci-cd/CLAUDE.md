...
## Purpose
Implements the **ci-cd** capability in Buddy.

## Runtime
- Entry point: `modules/ci-cd/run.mjs`
- Tools: `modules/ci-cd/tools/index.mjs`
- Dispatcher usage: `node modules/ci-cd/run.mjs &lt;tool&gt; [--arg value]`
