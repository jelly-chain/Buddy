...
## Purpose
Implements the **plugins** capability in Buddy.

## Runtime
- Entry point: `modules/plugins/run.mjs`
- Tools: `modules/plugins/tools/index.mjs`
- Dispatcher usage: `node modules/plugins/run.mjs &lt;tool&gt; [--arg value]`
