...
## Purpose
Implements the **polymarket** capability in Buddy.

## Runtime
- Entry point: `modules/polymarket/run.mjs`
- Tools: `modules/polymarket/tools/index.mjs`
- Dispatcher usage: `node modules/polymarket/run.mjs &lt;tool&gt; [--arg value]`
