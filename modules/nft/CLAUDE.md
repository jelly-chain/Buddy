...
## Purpose
Implements the **nft** capability in Buddy.

## Runtime
- Entry point: `modules/nft/run.mjs`
- Tools: `modules/nft/tools/index.mjs`
- Dispatcher usage: `node modules/nft/run.mjs &lt;tool&gt; [--arg value]`
