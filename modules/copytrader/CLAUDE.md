...
## Purpose
Implements the **copytrader** capability in Buddy.

## Runtime
- Entry point: `modules/copytrader/run.mjs`
- Tools: `modules/copytrader/tools/index.mjs`
- Dispatcher usage: `node modules/copytrader/run.mjs &lt;tool&gt; [--arg value]`
