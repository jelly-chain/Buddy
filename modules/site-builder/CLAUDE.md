...
## Purpose
Implements the **site-builder** capability in Buddy.

## Runtime
- Entry point: `modules/site-builder/run.mjs`
- Tools: `modules/site-builder/tools/index.mjs`
- Dispatcher usage: `node modules/site-builder/run.mjs &lt;tool&gt; [--arg value]`
