...
## Purpose
Implements the **portfolio** capability in Buddy.

## Runtime
- Entry point: `modules/portfolio/run.mjs`
- Tools: `modules/portfolio/tools/index.mjs`
- Dispatcher usage: `node modules/portfolio/run.mjs &lt;tool&gt; [--arg value]`
