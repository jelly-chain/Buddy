...
## Purpose
Implements the **firewall** capability in Buddy.

## Runtime
- Entry point: `modules/firewall/run.mjs`
- Tools: `modules/firewall/tools/index.mjs`
- Dispatcher usage: `node modules/firewall/run.mjs &lt;tool&gt; [--arg value]`
