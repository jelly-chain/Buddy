...
## Purpose
Implements the **rollback** capability in Buddy.

## Runtime
- Entry point: `modules/rollback/run.mjs`
- Tools: `modules/rollback/tools/index.mjs`
- Dispatcher usage: `node modules/rollback/run.mjs &lt;tool&gt; [--arg value]`
