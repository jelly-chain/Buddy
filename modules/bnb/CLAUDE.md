...
## Purpose
Implements the **bnb** capability in Buddy.

## Runtime
- Entry point: `modules/bnb/run.mjs`
- Tools: `modules/bnb/tools/index.mjs`
- Dispatcher usage: `node modules/bnb/run.mjs &lt;tool&gt; [--arg value]`
