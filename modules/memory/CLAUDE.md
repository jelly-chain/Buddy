...
## Purpose
Implements the **memory** capability in Buddy.

## Runtime
- Entry point: `modules/memory/run.mjs`
- Tools: `modules/memory/tools/index.mjs`
- Dispatcher usage: `node modules/memory/run.mjs &lt;tool&gt; [--arg value]`
