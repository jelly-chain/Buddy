...
## Purpose
Implements the **sentiment** capability in Buddy.

## Runtime
- Entry point: `modules/sentiment/run.mjs`
- Tools: `modules/sentiment/tools/index.mjs`
- Dispatcher usage: `node modules/sentiment/run.mjs &lt;tool&gt; [--arg value]`
