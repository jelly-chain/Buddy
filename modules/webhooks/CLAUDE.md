...
## Purpose
Implements the **webhooks** capability in Buddy.

## Runtime
- Entry point: `modules/webhooks/run.mjs`
- Tools: `modules/webhooks/tools/index.mjs`
- Dispatcher usage: `node modules/webhooks/run.mjs &lt;tool&gt; [--arg value]`
